#ifndef AstrosetMainWindow_H
#define AstrosetMainWindow_H
...
namespace Isis {
   ...
   *                           for the AstrosetMainWindow. Note that when running ipce without
   ...
   *                           state can be reset after the AstrosetMainWindow::show() causes resize and
   ...
   */
  class AstrosetMainWindow : public QMainWindow {
      Q_OBJECT
    public:
      explicit AstrosetMainWindow(QWidget *parent = 0);
      ~AstrosetMainWindow();
    ...
    private:
      ...
      class DashboardWidget *m_dashboard; //!< Mission control dashboard
      SlidingPanelManager *m_panelManager; //!< Sliding panel manager for tools
      QStackedWidget *m_centralStack; //!< Stack for dashboard and panels
  };
}

#endif // AstrosetMainWindow_H
